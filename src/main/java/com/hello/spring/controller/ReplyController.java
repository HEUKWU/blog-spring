...
public class ReplyController {
    ...
    public ResponseDto<ReplyResponseDto> addReply(@PathVariable Long id, @RequestBody ReplyRequestDto dto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        return replyService.addReply(id, dto, userDetails.getUser());
    }

    @PutMapping("api/reply/{id}")
    public ResponseDto<ReplyResponseDto> updateReply(@PathVariable Long id, @RequestBody ReplyRequestDto dto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseDto<?> replyLike(@PathVariable Long id, @AuthenticationPrincipal UserDetailsImpl userDetails) {
